...
$translations = [
	...
	'%d byte(s)'                                                                                                                               => ['%d байт', '%d байта', '%d байтов'],
	...
	'Routine has been called, %d row(s) affected.'                                                                                             => ['Была вызвана процедура, %d запись была изменена.', 'Была вызвана процедура, %d записи было изменено.', 'Была вызвана процедура, %d записей было изменено.'],
	'Call'                                                                                                                                     => 'Вызвать',
	...
	'%d process(es) have been killed.'                                                                                                         => ['Был завершён %d процесс.', 'Было завершено %d процесса.', 'Было завершено %d процессов.'],
	'Kill'                                                                                                                                     => 'Завершить',
	...
	'%d row(s)'                                                                                                                                => ['%d строка', '%d строки', '%d строк'],
	'Remove'                                                                                                                                   => 'Удалить',
	...
	'original'                                                                                                                                 => 'исходный',
	'%d item(s) have been affected.'                                                                                                           => ['Была изменена %d запись.', 'Были изменены %d записи.', 'Было изменено %d записей.'],
	...
	'Values'                                                                                                                                   => 'Параметры',
	'%d row(s) have been imported.'                                                                                                            => ['Импортирована %d строка.', 'Импортировано %d строки.', 'Импортировано %d строк.'],
	'Import'                                                                                                                                   => 'Импорт',
	...
	'Subject'                                                                                                                                  => 'Тема',
	'Send'                                                                                                                                     => 'Послать',
	'%d e-mail(s) have been sent.'                                                                                                             => ['Было отправлено %d письмо.', 'Было отправлено %d письма.', 'Было отправлено %d писем.'],
	...
	'%d query(s) executed OK.'                                                                                                                 => ['%d запрос выполнен успешно.', '%d запроса выполнено успешно.', '%d запросов выполнено успешно.'],
	...
	'Too many unsuccessful logins, try again in %d minute(s).'                                                                                 => ['Слишком много неудачных попыток входа. Попробуйте снова через %d минуту.', 'Слишком много неудачных попыток входа. Попробуйте снова через %d минуты.', 'Слишком много неудачных попыток входа. Попробуйте снова через %d минут.'],
