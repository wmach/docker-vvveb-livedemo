...
<!-- <base href="/plugins/database-management/adminer/"> -->
<title><?php echo $title_page; ?></title>
<link rel="stylesheet" type="text/css" href="/plugins/database-management/adminer/static/default.css">
<link rel="stylesheet" type="text/css" href="/plugins/database-management/adminer/static/adminer.css">
<?php echo script_src('/plugins/database-management/adminer/static/functions.js'); ?>
<?php echo script_src('/plugins/database-management/adminer/static/editing.js'); ?>
<?php if ($adminer->head()) { ?>
<link rel="shortcut icon" type="image/x-icon" href="/plugins/database-management/adminer/static/favicon.ico">
<link rel="apple-touch-icon" href="/plugins/database-management/adminer/static/favicon.ico">
...
//	header("X-Frame-Options: allow"); // ClickJacking protection in IE8, Safari 4, Chrome 2, Firefox 3.6.9
