...
*/
	...
	render: function(type, panel = false) {
		...
		if (component.init) component.init(nodeElement.get(0));
	}
};	
...
Vvveb.Gui = {
	...
	showChanges : function () {
		...
		$("#save-offcanvas [data-v-filename]").text(filename);
		$("#save-offcanvas input[data-v-filename]").val(filename);
		$("#save-offcanvas [data-v-basename]").val(page);
		$("#save-offcanvas [data-v-theme-folders]").val(folder);
