			  ...
			  <div class="billing_address">
				...
				<div class="row">
				  ...
				  <div class="col-12 mb-3">
					...
					<select class="form-select" id="billing_country_id" name="billing_address[country_id]" data-v-countries="" required="" data-v-zone-id="0">
				  ...
				  <div class="col-12 mb-3">
					...
					<select class="form-select" id="billing_zone_id" name="billing_address[zone_id]" data-v-zones="" required=""><option value="3513">Aberdeen</option></select>
				  </div>
				  <div class="col-12 mb-3">
				  ...
				  <div class="col-12 mb-3">
					<label class="col-form-label" for="postcode">Postcode <span class="text-danger text-small">*</span>
					</label>
					<input type="text" class="form-control" id="billing_postcode" name="billing_address[postcode]" minlength="3" value="">
				  </div>
				  <div class="col-12 mb-3">
			...
			<div id="checkout-shipping-container" class="shipping_address mb-2" style="display: none;">
			  ...
			  <div class="row">
				...
				<div class="col-12 mb-3">
				  ...
				  <select class="form-select" id="shipping_zone_id" name="shipping_address[zone_id]" data-v-zones=""><option value="3513">Aberdeen</option></select>
				</div>
				<div class="col-12 mb-3">
				  <label class="col-form-label" for="street_address">Address <span class="text-danger text-small">*</span>
				  </label>
				...
				<div class="col-12 mb-3">
				  ...
				  <input type="text" class="form-control" id="shipping_postcode" name="shipping_address[postcode]" minlength="3" value="" disabled="">
				</div>
				<div class="col-12 mb-3">
				  <label class="col-form-label" for="city">Town/City <span class="text-danger text-small">*</span>
				  </label>
				...
				<div class="col-12 mb-3">
				  ...
				  <input type="text" class="form-control" id="shipping_zone_id" name="shipping_address[zone_id]" minlength="3" value="" disabled="">
				</div>
				<div class="col-12 mb-3">
				  <label class="col-form-label" for="phone_number">Phone No <span class="text-danger text-small">*</span>
				  </label>
