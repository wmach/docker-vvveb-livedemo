...
class Site extends Base {
	...
	function index() {
		...
		$default	      = '{"logo":"logo.png","logo-sticky":"logo.png","logo-dark":"logo-white.png","logo-dark-sticky":"logo-white.png","favicon":"favicon.ico", "country_id":223, "zone_id":3655}';
		...
		$data             = $siteSql->getData($view->setting ?? []);
